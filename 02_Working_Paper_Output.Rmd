...
user_mods <- c("d ~ a + c; c~a; b~b", "d ~ c")


ls_theory <- theoRy(nodes = nodes, timing = timing, types=types, include_subsets = FALSE, 
                        user_mods=user_mods)

cmp_matrix <- add_compatible(ls_theory$formula_matrix, ref_mod = 1) ## Change ref_mod to whichever is your reference model (using base_mod and model variable in the formula matrix)
