...
## If you run a second, ls_theory should let users know whether models or nodes exists
...
ls_theory <- find_add_models(ls_theory = ls_theory, on_ls=TRUE, add_nodes = list(c(var_name = "f", timing = 1, type = "ctr", node_name = "X4")), user_mods = c("a ~ b + d; b ~ c + d; f ~ a + b"), assert_mod_num = 6)

## Swap back for later functions
