...
run_theory <- function(nodes, types, timing,include_subsets){
    causal_matrix <- build_causal_matrix(nodes, types, timing,include_subsets=include_subsets, return_node=FALSE)
